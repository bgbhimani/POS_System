...
const Orders = () => {
  ...
  return (
    <section className="bg-[#1f1f1f]  h-[calc(100vh-5rem)] overflow-hidden">
      ...
      <div className="grid grid-cols-3 gap-3 px-16 py-4 overflow-y-scroll  h-[calc(100vh-5rem)]  scrollbar-hide overflow-auto [&::-webkit-scrollbar:hidden] [-ms-overflow-style:none] [scrollbar-width:none]">
        {/* {
